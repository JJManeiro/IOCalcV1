...
public class Operation {
    /**
     * Float total será el número nulo que cambiará al resultado de la operación cuando toque.
     * Usaremos como operadores las letras S,R,M, y D. Las cuales son constantes finales de String.
     */
     ...
     * @throws Exception en el caso de que pongamos un numero 0 a la hora de dividir o hacer raíces.
     */
