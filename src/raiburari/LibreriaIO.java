...
public class LibreriaIO {
    /**
     * La f.int consola llamará un scanner para pedir los numeros y nombre.
     * La f.int popup usará JOptionPane para pedir los numeros y nombre.
     * Esta es la librería de entrada y salida. Ambos consola y popup tendrán constantes finales.
     */
     ...
     * @param op ayudara a escoger en el switch.
     * @return null.
     * @throws Exception en el caso que dejemos el número en blanco.
     */
